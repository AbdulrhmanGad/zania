...
class ConstructionProject(models.Model):
    ...
    financial_offer_id = fields.Many2one('financial.offer', string="Financial")
    ...
    def create_financial_offer(self):
        ...
        if len(x.ids) >= len(self.breakdown_ids.ids):
            ...
            raise ValidationError(_('All Break Down must in State financial'))
    ...
    def action_view_form_financial(self):
