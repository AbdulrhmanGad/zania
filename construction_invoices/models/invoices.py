...
class ConstructionInvoice(models.Model):
    ...
    current_value = fields.Float(string='Current Value', compute='compute_due_amount')
    due_amount = fields.Float(string='Due Amount', compute='compute_due_amount')
    invoice_total = fields.Float(string='Invoice Total', compute='compute_due_amount')
...
class ConstructionInvoiceLine(models.Model):
    ...
    price_unit = fields.Float(string='Price Unit', conpute="compute_contract_qty_price")
    ...
    competition_per = fields.Float(  string='Competition Percentage', compute="compute_competition_per")
